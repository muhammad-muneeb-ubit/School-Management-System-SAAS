...
export default function Exams() {
    ...
    const handlePublish = async (examId) => {
        if (window.confirm('Are you sure you want to publish these results? Parents and Students will be able to see them.')) {
            try {
                await api.put(`/exams/${examId}/publish`);
                alert('Results published successfully!');
                fetchExams(); // Refresh the table to show the green "Published" badge
            } catch (err) {
