...
import { ArchiveCardSkeleton, DashboardHeaderSkeleton } from '../../components/skeletons';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-3">
            {sessions.map(s => (
              <div key={s._id} className="flex justify-between items-center p-3 border border-gray-300 rounded">
                <div>
