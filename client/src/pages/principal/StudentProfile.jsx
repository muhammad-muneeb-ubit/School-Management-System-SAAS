...
//       try {
//         // Using the summary endpoint because it has attendance % and fee status!
...
//   if (!data) return <DashboardLayout><Loader /></DashboardLayout>;
...
//         <div className="px-6 pb-6 -mt-12 flex flex-col md:flex-row items-center md:items-end">
//           <div className="bg-blue-100 border-4 border-white rounded-full w-24 h-24 flex items-center justify-center text-blue-600 text-4xl font-bold shadow-md">
...
//                 <p className="font-medium">{student.parentId?.profile?.firstName} {student.parentId?.profile?.lastName}</p>
//               </div>
//             </div>
//             <div className="flex items-center">
//               <div className="w-10 h-10 bg-blue-50 rounded-full flex items-center justify-center mr-3">
...
//         {/* Middle & Right Column: Quick Stats */}
