...
import { HeadingWithButtonSkeleton, ClassAssignmentsSkeleton, DashboardHeaderSkeleton } from '../../components/skeletons';
  ...
  return (
    <>  {loading ? (
      <DashboardLayout>
        ...
        {[1, 2, 3, 4].map((i) => <ClassAssignmentsSkeleton key={i} full={true} />)}
        </div>
      </DashboardLayout>
    )
      :
